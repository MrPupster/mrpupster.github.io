...
// 					console.log('Queue before: ' + ( $(this).parent().parent().parent().find('.hoverline').queue() ).length);
					$link = $(this);
...
// 					$(this).parent().parent().parent().find('.hoverline').animate({
// 						'left'	:	$link.parent().position().left,
// 						'width'	:	$link.parent().width()
// 					}, {duration: 300, easing: 'linear', queue: 'testQueue'}).dequeue('testQueue');
...
// 					console.log('Queue after: ' + ( $(this).parent().parent().parent().find('.hoverline').queue() ).length);
// 					console.log('Current: ' + ( $(this).queue('testQueue') ).length);
				}
...
// 				$(this).css({'color' : 'red'});
		...
		// 				$(this).find('.hoverline').css({'background' : 'orange'});
					console.log('Leave hover: ' + $link.parent().position().left + ' | ' + $link.parent().width());
				}
...
// 		if (et < 450 && et > -1 * (eh - 200)){
		if (et <= 105 && et + eh >= 100){
			console.log('Main if | et_' + key + ' - ' + et);
...
// 				console.log('Left: ' + $('#tlm' + key).parent().position().left + ' | ' + $link.parent().width());
			...
			xxx[key] = true;
		    } else if (et + eh < 100 && et + eh > 50) {
			    console.log('Else 1 | et_' + key + ' - ' + et);
			if (xxx[key] == null || xxx[key] == true) {
				console.log('Else 2 | et_' + key + ' - ' + et);
				$('#tlm' + key).css("color", "");
// 				$link = $('#tlm' + key);
				if ((key == Object.keys(xxx)[Object.keys(xxx).length-1]) && et > 105) {
					$('#tlm' + key).parent().parent().parent().find('.hoverline').stop().animate({
					'left'	:	0,
					'width'	:	0
					}, 200);
