...
//         $('#list0').data('y', {2019: 4});
        ...
        $.each(eTimeline.find('article'), function (index, value) {
            ...
            if (settings.effect && settings.effect != 'none') $(this).addClass('animated ' + settings.effect).css('animation-delay', '1.5s')
        });
        if (settings.showGroup) {
		$.each(eTimeline.find('div[class*="group"]'), function (index, value) {
		 	if (settings.effect && settings.effect != 'none') $(this).addClass('animated fadeInLeft')			
            	})
