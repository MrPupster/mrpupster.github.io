		...
		this.each(function(){
			...
			function moveHover(){
				if (!$this.find('ul li a.clicked').hasClass('clicked')) {
					...
					console.log('Queue before: ' + ( $(this).parent().parent().parent().find('.hoverline').queue('testQueue') ).length);
					$link = $(this);
...
// 					}, 300, 'easeOutCubic');
	...
	// 				$(this).parent().parent().parent().find('.hoverline').css({'background' : 'pink'});
					...
					console.log('Queue after: ' + ( $(this).parent().parent().parent().find('.hoverline').queue('testQueue') ).length);
