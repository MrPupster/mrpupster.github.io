...
// 				}, 200);
				...
				console.log('Force clicked: ' +  $('#tlm' + key).parent().parent().parent().find('ul li a.clicked'));
// 				if ($('#tlm' + key).parent().parent().parent().find('ul li a.clicked')) {
...
// 				$('#tlm' + key).parent().parent().parent().find('.hoverline').css("display", "inherit");
			...
			if (xxx[key] == null || xxx[key] == true) {
				...
				if (et <= 85) {
					...
					$('#tlm' + key).parent().parent().parent().find('.hoverline').stop().animate({
					'left'	:	$link.parent().position().left + $link.parent().width() * 0.75,
					'width'	:	$link.parent().width() * 0.5
					}, 200);
				} else if (et > temp) {
					$('#tlm' + key).parent().parent().parent().find('.hoverline').stop().animate({
					'left'	:	$link.parent().position().left - $link.parent().width() * 0.25,
					'width'	:	$link.parent().width() * 0.5
					}, 200);
				}
