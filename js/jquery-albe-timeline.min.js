...
//             var irmaos = agrupador.siblings('article[id^="a' + ano + '"]');
            ...
            if (irmaos.length > 0) slot.insertAfter(irmaos.last());
                      ...
                      if (agrupador.length === 0) {
                agrupador = $('<div>').attr('id', ('y' + ano)).addClass('group' + ano).text(ano).attr('title', 'b').attr('name', ('y' + ano));
                $(eTimeline).append(agrupador);
//                 var anchor = $('<a>').attr('href', ('#y' + ano)).text(ano).attr('title', $('#list0').data('y'));
                var anchor = $('<a>').attr('href', ('#y' + ano)).text(ano).attr('title', 'a').attr('name', ('y' + ano));
                eMenu.append($('<li>').append(anchor))
            }
...
//         $('#list0').data('y', {2019: 4});
    ...
    $(_this).children('#y2019').attr('title', 'word');
...
//     $('#y2018')[0].attr('title', 'word');
//     $('#y2017')[0].setAttribute('title', 'aaa');
//     $('.group2019').attr('title', 'd');
    
//     $('#y2018')[0].attr('data-original-title', 'New value');
