...
//             }
            ...
            var badge = $('<a>').addClass('badge').attr('title', irma);
...
//             var irmaos = agrupador.siblings('article[id^="a' + ano + '"]');
            ...
            if (irmaos.length > 0) slot.insertAfter(irmaos.last());
                      ...
                      if (agrupador.length === 0) {
                agrupador = $('<div>').attr('id', ('y' + ano)).addClass('group' + ano).text(ano).attr('name', ('y' + ano));
                $(eTimeline).append(agrupador);
//                 var anchor = $('<a>').attr('href', ('#y' + ano)).text(ano).attr('title', $('#list0').data('y'));
                var anchor = $('<a>').attr('href', ('#y' + ano)).text(ano).attr('name', ('y' + ano)).attr('id', ('y' + ano));
                eMenu.append($('<li>').append(anchor))
            }
//             qqq[ano] = (irmaos.length + 1);
        });
...
//         $('#list0').data('y', {2019: 4});
        ...
        eTimeline.appendTo(_this)
               ...
               $('#y2018').attr('title', 'word');
//     $('#y2017').setAttribute('title', 'aaa');
    $('.group2019').attr('title', 'd');
    
    $('#y2018').attr('data-original-title', 'New value');
    $('#y2017').attr('data-original-title', 'New value');
    $('.group2019').attr('data-original-title', 'New value');
    $('[name="y2016"]').attr('data-original-title', '123');
        $('[name="y2016"]').attr('title', '123');
//     this.querySelectorAll('[name="y2016"]').attr('data-original-title', '321');
        console.log($('#y2018'));
        console.log($('.group2019'));
        console.log($('[name="y2016"]'));
