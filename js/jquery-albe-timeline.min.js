...
//     }
	...
	$.each(y, function (key, value) {
		...
		//     if (wt + wh >= et && wt + wh - ehh * 2 <= et + (wh - ehh)){
		if (et < 450 && et > -1 * (eh - 300)){
			if (xxx[key] == null || xxx[key] == false) {
				$('[name="y' + key + '"]').css("color", "#6441a5");
			    console.log('Блок yyy' + key + ' в области видимости');
				console.log('wt | wh | et | eh | eb: ' + wt + ' | ' + wh + ' | ' + et + ' | ' + eh + ' | ' + xxx[key]);
			}
			xxx[key] = true;
		    } else {
			if (xxx[key] == null || xxx[key] == true) {
				$('[name="y' + key + '"]').css("color", "");
			    console.log('Блок yyy' + key + ' скрыт');
				console.log('wt | wh | et | eh | bsh: ' + wt + ' | ' + wh + ' | ' + et + ' | ' + eh + ' | ' + block_show);
			}
			xxx[key] = false;
		    }
    	})
...
//             }
             ...
             if (agrupador.length === 0) {
                ...
                var yyy = $('<div>').addClass('yyy' + ano).append(agrupador);
                $(eTimeline).append(yyy);
//                 var anchor = $('<a>').attr('href', ('#y' + ano)).text(ano).attr('title', $('#list0').data('y'));
                var anchor = $('<a>').attr('href', ('#y' + ano)).text(ano).addClass('scrollto').attr('name', ('y' + ano)).attr('data-toggle', 'tooltip').attr('data-placement', 'bottom');
                eMenu.append($('<li>').append(anchor))
            }
       ...
       $('[data-toggle="tooltip"]').tooltip({
        ...
        $(document).ready(function(){
            $('a.scrollto').on('click', function(e){
                e.preventDefault();
//                 $('.scroll-test').stop().animate({ scrollTop: $(this.hash) }, 500);
                $('.scroll-test').scrollTo($(this.hash), 500);
            });
        });
