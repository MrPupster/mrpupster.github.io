...
// 		});
	...
	$.fn.hoverline = function(options){
		...
		this.each(function(){
			...
			function moveHover(){
				if (!$(this).parent().parent().parent().find('li a.clicked').hasClass('clicked')) {
	...
	// 				$(this).parent().parent().parent().find('.hoverline').css({'background' : 'pink'});
			...
			function clickedItem(){
				$(this).parent().parent().parent().find('li a.currElement').removeClass('currElement');
...
// 				$(this).css({'color' : 'red'});
			...
			function leaveHover(){
				if (!$(this).parent().parent().parent().find('li a.clicked').hasClass('clicked')) {
					...
					$link = $(this).find('li a.currElement');
		...
		// 				$(this).find('.hoverline').css({'background' : 'orange'});
			...
			$this.find('li a').bind('click',clickedItem);
			
			$this.find('li a').bind('mouseenter',moveHover);
			
			$this.bind('mouseleave',leaveHover);
			
			$this.find('li a').eq(settings.start-1).addClass('currElement');
...
// 		    eMenuD.append(eMenu);
		    if (settings.effect && settings.effect != 'none') eMenu.addClass('animated fadeInRight').css('animation-delay', '0.5s')
...
//                 $('#modalBody').stop().animate({ scrollTop: $(this.hash).offset().top }, 500);
	...
	$(document).ready(function(){
		$('#timeline-menu').makeNavbar();
		$('#timeline-menu').hoverline({
			  'color'       		:		'#6441a5',
			  'height'				:		'5px',
			  'start'				:		'1',
			  'speed'				:		'200',
